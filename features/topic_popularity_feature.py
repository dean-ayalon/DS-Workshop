...
def create_topics_popularity(main_table, topics, with_confidence=True, with_test=False):
    ...
    #choose if you want to calculate with confidence or not
    if with_confidence:
    ...
    #drop unnecessary columns and duplicated rows and sum the whole values we got for each ad (since an ad can have
    # different topics)
