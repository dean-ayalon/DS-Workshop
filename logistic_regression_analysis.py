...
model = sklearn.ensemble.GradientBoostingClassifier(verbose=True)
...
best_model = cv.fit(train_points, train_labels)
...
display_probs = best_model.predict_proba(test_points)[:, 1]
